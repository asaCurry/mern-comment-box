...
class CommentBox extends Component {
  constructor() {
    ...
    this.state = {
     ...
     this.pollInternval = null;
  }

  componentDidMount() {
    this.loadCommentsFromSever();
    if (!this.pollInternval) {
      this.pollInternval = setInterval(this.loadCommentsFromSever, 2000);
    }
  }

  componentWillMount () {
    if (this.pollInternval) clearInterval(this.pollInternval);
    this.pollInterval = null;
  }

loadCommentsFromSever = () => {
